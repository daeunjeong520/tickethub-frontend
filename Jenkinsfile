pipeline {
  ...
  environment {
    awsecrRegistry = '851725651012.dkr.ecr.ap-northeast-2.amazonaws.com/tickethub_frontend'
    ...
    //gitEmailApplication = 'jungde1345@gmail.com'
    //gitNameApplication = 'daeunjeong520'
  }
